...
>###Complie
>g++ -std=c++11 -I/usr/local/include/cryptopp \*.cpp cryptogm/\*.cpp GeeMail/\*.cpp GraphicEngine/\*.cpp -lcryptopp -lsqlite3 -o cgi-bin/gee-mail.cgi && chmod 755 cgi-bin/gee-mail.cgi
